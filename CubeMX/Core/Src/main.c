...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(MIN_LED_GPIO_Port, MIN_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : MIN_LED_Pin */
  GPIO_InitStruct.Pin = MIN_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MIN_LED_GPIO_Port, &GPIO_InitStruct);
